...
export default function MyPortfolio() {
	...
	useEffect(() => {
		const startIdx = itemOffset * itemsPerPage;
		const endIdx = startIdx + itemsPerPage;
		setCurrentItems(data?.portfolio?.slice(startIdx, endIdx));
		setPageCount(Math.ceil(data?.portfolio?.length / itemsPerPage));
	}, [itemOffset, data?.portfolio]);
